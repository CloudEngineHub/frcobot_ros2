...
#define     ERR_CMD_TLS_ENABLE_STATE               -22    //机器人SDK与服务端的指令协议加密开启状态不一致
#define     ERR_CNDE_STATES_START_FAILED           -21	  //机器人CNDE状态启动失败
#define     ERR_TOO_MANY_STATES                    -20    //配置状态字段长度超限
#define     ERR_NEED_AT_LEAST_ONE_STATE            -19    //至少需要配置一个状态字段
#define     ERR_STATE_INVALID                      -18    //状态字段不存在
#define     ERR_STATE_ALREADY_EXISTS               -17    //状态字段重复配置
